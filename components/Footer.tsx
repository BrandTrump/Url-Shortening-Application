...
function Footer() {
  return (
    <div className="bg-slate-800">
      <div className="flex flex-col items-center justify-center p-20 text-center space-y-8 md:flex-row md:items-start md:space-y-0 md:justify-between md:flex-wrap 2xl:w-3/5 mx-auto">
