...
function Card({ shortenedUrl, searchString }: Props) {
  return (
    <div className="bg-white w-96 flex justify-center flex-col items-center mx-auto mt-10 rounded-xl space-y-4 p-6 md:w-3/4 md:flex-row md:items-center md:space-y-0 md:space-x-10 md:shadow-sm">
